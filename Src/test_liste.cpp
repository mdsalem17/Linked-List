...
int main() {
  ...
  l1.afficher() ; // [ 11 10 ]
  assert(l1.tete()->getValue() == 11) ;
  assert(l1.queue()->getValue() == 10) ;
  ...
  assert(l2.tete()->getValue() == 20) ;
  assert(l2.queue()->getValue() == 10) ;
  ...
  std::cout << "attendu : [ 11 10 ]" << std::endl ;
  l3.afficher() ; // [ 11 10 ]
  assert(l3.tete()->getValue() == 11) ;
  assert(l3.queue()->getValue() == 10) ;
